...
rosbag2 with bounded escalation, validates recorder-local output, and atomically
writes `.status/artifacts-final.json`. This quiescence barrier prevents required
artifacts from changing during host validation and manifest commit.
