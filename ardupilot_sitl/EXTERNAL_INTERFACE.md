...
The selected target deliberately slows the final touchdown while retaining
ample headroom below the competition's 1.0 m/s vertical-speed limit. Preserved run
...
production run remains authoritative for the 0.10 m/s target's contact speed,
