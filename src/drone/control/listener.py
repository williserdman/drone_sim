...
L = GPSCoord(39.5681199, -76.2071685, CRUISE_ALT)  # Need to change hardcode for comp
...
SMALL_TARGET = GPSCoord(39.5681250, -76.2078706, 10)
BIG_TARGET = GPSCoord(39.5681301, -76.2075174, 10)
TARGET = SMALL_TARGET
